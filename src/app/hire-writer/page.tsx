...
const SERVICES = [
  ...
  },
  {
    ...
    href: '/hire-writer/new?service=assignments',
  },
  {
    icon: '🎓',
  ...
  {
    icon: '📚',
    title: 'Final Year Projects (Chapters 1–5)',
    desc: 'Complete research chapters with questionnaires, methodology, results, and discussion.',
    startingPrice: 1400,
    unit: 'page',
    badge: 'Projects',
    href: '/hire-writer/new?service=projects',
  },
  {
    icon: '✨',
    title: 'Proofreading & Turnitin Paraphrasing',
    desc: 'Comprehensive language refinement, style uniformity, and certified plagiarism reduction.',
    startingPrice: 600,
    unit: 'page',
    badge: 'Quality Check',
