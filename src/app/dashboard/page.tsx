        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="p-6 bg-white rounded-3xl border border-slate-200/80 shadow-xs space-y-1">
              ...
              <span className="text-[11px] text-indigo-600 font-semibold block">Instant Downloads</span>
            </div>
              ...
              {isLoading ? (
                ...
                purchasedNotes.length === 0 ? (
                  <div className="text-center py-12 space-y-3">
                    ...
                    <h4 className="text-sm font-bold text-slate-900">No purchased notes yet.</h4>
                    <p className="text-xs text-slate-500 max-w-xs mx-auto">
                        ...
                        <div key={purchase.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="space-y-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs text-slate-400">{doc?.institution || 'Unknown Institution'}</span>
                            </div>
                            <h4 className="text-sm font-bold text-slate-900">{doc?.title || 'Untitled Document'}</h4>
                            <p className="text-xs text-slate-500">
                              Price Paid: {formatCurrency(purchase.amount)} • Purchased: {formatDate(purchase.created_at)}
                            </p>
                          </div>
